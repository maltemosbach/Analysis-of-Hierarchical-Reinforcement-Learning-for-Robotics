...
hparams = [{}] * len(combinations["run"])*len(combinations["use_target"])*len(combinations["replay_k"])*len(combinations["sg_n"])*len(combinations["ac_n"])
...
for i in range(len(combinations["ac_n"])):
    for j in range(len(combinations["sg_n"])):
        for k in range(len(combinations["replay_k"])):
            for l in range(len(combinations["use_target"])):
                for m in range(len(combinations["run"])):
                    hparams[i*len(combinations["run"])*len(combinations["use_target"])*len(combinations["replay_k"])*len(combinations["sg_n"]) + j*len(combinations["run"])*len(combinations["use_target"])*len(combinations["replay_k"]) + k*len(combinations["run"])*len(combinations["use_target"]) + l*len(combinations["run"]) + m] = {
                        "ac_n"          : combinations["ac_n"][i],
                        "sg_n"          : combinations["sg_n"][j],
                        "replay_k"      : combinations["replay_k"][k],
                        "use_target"    : combinations["use_target"][l],
                        "run"     : combinations["run"][m]
...
for m in range(len(combinations["run"])*len(combinations["use_target"])*len(combinations["replay_k"])*len(combinations["sg_n"])*len(combinations["ac_n"])):
    print("Run number {no_run} of {total_runs}:".format(no_run=m, total_runs=int(len(combinations["run"])*len(combinations["use_target"])*len(combinations["replay_k"])*len(combinations["sg_n"])*len(combinations["ac_n"])-1)))
