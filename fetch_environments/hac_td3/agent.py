...
class Agent():
    ...
    def log_tb(self, step):
        ...
        self.writer.add_histogram('TD3_layer_0/main/Q_1/_0/kernel:', self.layers[0].policy.main_vars[0].eval(session=self.sess), step)
        self.writer.add_histogram('TD3_layer_0/main/Q_2/_0/kernel:', self.layers[0].policy.main_vars[8].eval(session=self.sess), step)
        self.writer.add_histogram('TD3_layer_0/target/Q_1/_0/kernel:', self.layers[0].policy.target_vars[0].eval(session=self.sess), step)
        self.writer.add_histogram('TD3_layer_0/target/Q_2/_0/kernel:', self.layers[0].policy.target_vars[8].eval(session=self.sess), step)
        self.writer.add_histogram('TD3_layer_0/main/pi/_0/kernel:0:', self.layers[0].policy.main_vars[16].eval(session=self.sess), step)
        self.writer.add_histogram('TD3_layer_0/target/pi/_0/kernel:0:', self.layers[0].policy.target_vars[16].eval(session=self.sess), step)


        self.writer.add_scalar('layer_0_Q_1_loss', self.layers[0].policy.Q_1_loss, step)
        self.writer.add_scalar('layer_0_Q_2_loss', self.layers[0].policy.Q_2_loss, step)
