        ...
        for k in range(len(combinations["replay_k"])):
            for l in range(len(combinations["layers"])):
                for m in range(len(combinations["use_target"])):
                    for n in range(len(combinations["run"])):
...
for m in range(len(combinations["run"])*len(combinations["layers"])*len(combinations["replay_k"])*len(combinations["sg_n"])*len(combinations["ac_n"])):
    print("Run number {no_run} of {total_runs}:".format(no_run=m, total_runs=int(len(combinations["run"])*len(combinations["layers"])*len(combinations["replay_k"])*len(combinations["sg_n"])*len(combinations["ac_n"])-1)))
