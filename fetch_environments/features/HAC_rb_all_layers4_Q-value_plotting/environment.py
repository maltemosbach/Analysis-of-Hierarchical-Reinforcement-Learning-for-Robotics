...
class Environment():
    ...
    def __init__(self, goal_space_test, project_state_to_end_goal, end_goal_thresholds, subgoal_bounds, project_state_to_subgoal, subgoal_thresholds, max_actions = 50, show = False):

        self.name = "FetchReach-v1"
    ...
    def get_next_goal(self,test):
        ...
        if useGymGoals:
            ...
            assert self.goal_space_test is not None, "Need goal space for testing. Set goal_space_test variable in \"design_agent_and_env.py\" file"
    ...
    def display_subgoals(self,subgoals):
        # subgoals array contains [subgoal1, subgoal2, endgoal] for three layers
        # and [subgoal, endgoal] for two layers
