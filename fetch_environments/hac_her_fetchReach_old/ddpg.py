...
class DDPG(object):
    ...
    def _preprocess_og(self, o, ag, g):
        if self.relative_goals:
            ...
            g = g.reshape(*g_shape)
        #print("In ddpg.preprocess_inputs with g={} and o={}".format(g, o))
        o = np.clip(o, -self.clip_obs, self.clip_obs)
        g = np.clip(g, -self.clip_obs, self.clip_obs)
        #print("After preprocessing with g={} and o={}".format(g, o))
        return o, g
    ...
    def sample_batch(self):
        ...
        print("In ddpg.py sample_batch with transitions:", transitions)
    ...
    def _global_vars(self, scope):
        ...
        #print('For ddpg.py in _global_vars with res:', res)
        return res

    def _create_network(self, reuse=False):
        logger.info("Creating a DDPG agent with action space %d x %s..." % (self.dimu, self.max_u))
        #sself.sess = tf_util.get_session()
        self.sess = tf.compat.v1.Session()
        print('in ddpg.py with self.sess:', self.sess)
