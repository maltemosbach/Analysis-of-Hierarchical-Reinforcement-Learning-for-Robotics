...
hparams = [{}] * len(combinations["no_of_run"])*len(combinations["replay_k"])*len(combinations["sg_n"])*len(combinations["ac_n"])
    ...
    for j in range(len(combinations["sg_n"])):
        for k in range(len(combinations["replay_k"])):
            for l in range(len(combinations["no_of_run"])):
                hparams[i*len(combinations["no_of_run"])*len(combinations["replay_k"])*len(combinations["sg_n"]) + j*len(combinations["no_of_run"])*len(combinations["replay_k"]) + k*len(combinations["no_of_run"]) + l] = {
...
for m in range(len(combinations["no_of_run"])*len(combinations["replay_k"])*len(combinations["sg_n"])*len(combinations["ac_n"])):
    print("Run number {no_run} of {total_runs}:".format(no_run=m, total_runs=int(len(combinations["no_of_run"])*len(combinations["replay_k"])*len(combinations["sg_n"])*len(combinations["ac_n"])-1)))
