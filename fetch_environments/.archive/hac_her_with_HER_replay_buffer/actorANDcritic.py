...
class ActorAndCritic():
    ...
    def __init__(self, sess, writer, env, batch_size, replay_buffer, layer_number, FLAGS, hidden, layers, sample_transitions, Q_lr=0.001, pi_lr=0.001, tau=0.05, 
        ...
        self.input_dims = {"o" : env.state_dim, "g" : env.goal_dim, "u" : 0}
