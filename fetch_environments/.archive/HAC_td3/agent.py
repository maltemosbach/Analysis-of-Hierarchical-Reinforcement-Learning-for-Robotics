        ...
        if log_loss:
            if self.hparams["modules"][0] == "ddpg":
                ...
                if self.hparams["buffer"][0] == "replay":
                    ...
                    self.writer.add_scalar('layer 0 experience_buffer size', self.layers[0].experience_buffer.size, step)

                ret.append(self.layers[0].policy.critic_loss)
            if self.hparams["layers"] > 1:
                if self.hparams["modules"][1] == "ddpg" or self.hparams["modules"][1] == "ddpgL1":
                    ...
                    if self.hparams["buffer"][1] == "replay":
                        ...
                        self.writer.add_scalar('layer 1 experience_buffer size', self.layers[1].experience_buffer.size, step)
                    ...
                    self.writer.add_histogram('layer_1_critic_weights_infer_1', self.layers[1].critic.weights_infer_1[0].eval(session=self.sess), step)
                    self.writer.add_histogram('layer_1_critic_weights_infer_2', self.layers[1].critic.weights_infer_2[0].eval(session=self.sess), step)
                    self.writer.add_histogram('layer_1_critic_weights_target_1', self.layers[1].critic.weights_target_1[0].eval(session=self.sess), step)
                    self.writer.add_histogram('layer_1_critic_weights_target_2', self.layers[1].critic.weights_target_2[0].eval(session=self.sess), step)
                    self.writer.add_histogram('layer_1_actor_weights', self.layers[1].actor.weights[0].eval(session=self.sess), step)
                    self.writer.add_histogram('layer_1_actor_target_weights', self.layers[1].actor.target_weights[0].eval(session=self.sess), step)
